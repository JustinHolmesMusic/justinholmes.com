export const setStoneABI = [{
        ...
        "inputs": [{"name": "artist_id", "type": "uint16", "internalType": "uint16"}, {
            "name": "blockheight",
            "type": "uint64",
            "internalType": "uint64"
        }],
        ...
        "type": "function",
        "name": "getSetId",
        "inputs": [{"name": "artistId", "type": "uint16", "internalType": "uint16"}, {
            "name": "blockHeight",
            "type": "uint64",
            "internalType": "uint64"
        ...
        "outputs": [{
            ...
            "components": [{"name": "showBytes", "type": "bytes32", "internalType": "bytes32"}, {
                "name": "order",
                "type": "uint8",
                "internalType": "uint8"
                ...
                "type": "string",
                "internalType": "string"
            }, {"name": "paidAmountWei", "type": "uint256", "internalType": "uint256"}, {
                "name": "rabbitHash",
                "type": "bytes32",
        ...
        "inputs": [{"name": "setId", "type": "bytes32", "internalType": "bytes32"}],
        "outputs": [{
            "name": "",
            "type": "tuple[]",
            "internalType": "struct SetStone.Stone[]",
        ...
        "type": "function",
        "name": "isValidRabbit",
        "inputs": [{"name": "rabbitHash", "type": "bytes32", "internalType": "bytes32"}, {
            "name": "showBytes",
            "type": "bytes32",
            "internalType": "bytes32"
        }],
        ...
        "inputs": [{"name": "artist_id", "type": "uint16", "internalType": "uint16"}, {
            ...
            "type": "uint64",
            "internalType": "uint64"
        }, {"name": "rabbitHashes", "type": "bytes32[]", "internalType": "bytes32[]"}, {
            "name": "numberOfSets",
            "type": "uint8",
            "internalType": "uint8"
        ...
        "outputs": [{"name": "showBytes", "type": "bytes32", "internalType": "bytes32"}, {
            "name": "order",
            "type": "uint8",
            "internalType": "uint8"
        }, {"name": "color", "type": "uint16", "internalType": "uint16"}, {
